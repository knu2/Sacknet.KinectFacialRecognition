...
namespace Sacknet.KinectFacialRecognition
{
    ...
    public class FacialRecognitionProcessor
    {
        ...
        public void ProcessX(RecognitionResult result, TrackingResults trackingResults)
        {
            GraphicsPath origPath;
            ...
            var face3DPoints = trackingResults.Face3DPoints;
            ...
            using (var croppedBmp = new Bitmap(width, height))
            {
                ...
                using (var grayBmp = croppedBmp.MakeGrayscale(100, 100))
                {
                    ...
                    if (this.Recognizer != null)
                        key = this.Recognizer.Recognize(face3DPoints);
